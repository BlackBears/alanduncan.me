...
feedConfiguration = FeedConfiguration
    { feedTitle       = "Alan Duncan"
    , feedDescription = "RSS feed for Alan Duncan's blog"
    , feedAuthorName  = "Alan Duncan"
    , feedAuthorEmail = "duncan.alan@mac.com"
    , feedRoot        = "http://alanduncan.me"
    }
